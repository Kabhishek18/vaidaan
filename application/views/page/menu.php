        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="page-title-wrap">
                    <h1><?php $cid = $this->uri->segment(4,0); 
                    echo urldecode($cid)?></h1>
                </div>
            </div>
            <!-- Page Title Area End -->
            ...
            <div class="col-6 m-auto">
                <nav class="page-breadcrumb-wrap">
                    <ul class="nav justify-content-end">
                        ...
                        <li><a href="javascript:void(0);"><?php $cid = $this->uri->segment(2,0);
                         $cat=$this->cart_model->Getcat($cid);
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="single-product-item">
                                        ...
                                        <div class="product-details">
                                            <a href="javascript:void(0)" class="product-cat-name" style="text-transform: capitalize;"><?=$catitem['cat_name']?></a>
