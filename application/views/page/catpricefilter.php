                        ...
                        <div class="sidebar-body">
                             <!--  -->
                                 <ul class="sidebar-list"> 
                                    ...
                                    <li><a href="<?=base_url()?>category/<?=$cid?>/price/2500/3000">  INR 2500 - INR 3000</a> </li>
                                    <li><a href="<?=base_url()?>category/<?=$cid?>/price/3000/3500">  INR 3000 -INR 3500 </a></li>
                                    <li><a href="<?=base_url()?>category/<?=$cid?>/price/3500/200000">  Above INR 3500 </a></li>
