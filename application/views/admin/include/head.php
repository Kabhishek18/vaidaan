...
<head>
    ...
    <title>Vaidaan Admin </title>
    <link rel="apple-touch-icon" href="<?=base_url()?>resource/admin/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?=base_url()?>resource/admin/app-assets/images/ico/favicon.ico">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600" rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/app-assets/vendors/css/vendors.min.css">
    ...
    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/app-assets/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/app-assets/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/app-assets/css/colors.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/app-assets/css/components.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/app-assets/css/themes/dark-layout.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/app-assets/css/themes/semi-dark-layout.css">
    ...
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/admin/assets/css/style.css">
    <!-- END: Custom CSS-->
