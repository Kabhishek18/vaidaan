                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" style="text-transform: capitalize;">Post Add
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" style="text-transform: capitalize;">Add New </h4>
                                </div>
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <!-- <p>Snow is a clean, flat toolbar theme.</p> -->
                                        <?php echo form_open_multipart('Admin/InsertBlog',' ') ?> 
                                         <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <input type="text" name="blog_title" class="form-control" placeholder="Blog Title" required data-validation-required-message="This Blog Title field is required">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="file" name="blog_image" class="form-control" placeholder="File" required data-validation-required-message="This File field is required" accept="image/png, image/jpeg, image/jpg">
                                                        </div>
                                                    </div>
                                                </div>
